...
export default function ProfileScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      {/* My Tickets */}
      <TouchableOpacity
        style={[styles.menuRow, { borderColor: theme.border }]}
        onPress={() => navigation.navigate('MyTickets')}
      >
        <Ionicons name="ticket-outline" size={20} color={theme.primary} />
        <Text style={[styles.menuLabel, { color: theme.text }]}>My Tickets & Receipts</Text>
...
const styles = StyleSheet.create({
  ...
  menuRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 16, borderBottomWidth: 1, marginBottom: 4 },
